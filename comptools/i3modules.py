...
class AddIceTopChargeDistance(icetray.I3Module):
    ...
    def fit_LDF_params(self, charges, distances, lap_log_s125, lap_beta):
    ...
    def Physics(self, frame):
        ...
        if dists and charges:
            ...
            try:
                ...
                tank_dist_mask = dists > 11
                beta, log_s125 = self.fit_LDF_params(charges[tank_dist_mask],
                    dists[tank_dist_mask], lap_log_s125, lap_beta)
