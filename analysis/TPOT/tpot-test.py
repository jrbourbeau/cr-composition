...
if __name__ == '__main__':
    ...
    standard_cut_keys = ['LLHlap_reco_exists', 'LLHlap_zenith', 'num_hits_1_30', 'IT_signal',
                         'StationDensity', 'max_qfrac_1_30', 'LLHlap_containment',
                         'energy_range']
    ...
    tpot = TPOTClassifier(generations=args.generations, population_size=args.popsize, num_cv_folds=args.cvfolds, verbosity=2, scoring='accuracy')
