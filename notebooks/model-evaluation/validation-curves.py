...
if __name__ == "__main__":
    ...
    for train_index, test_index in skf.split(sim_train_df, sim_train_df['target']):
        ...
        for class_ in pipeline.classes_:
            ...
            # print(class_, composition)

            comp_mask_train = y_train == class_
            # comp_mask_train = np.array([comp.dataframe_functions.label_to_compy_train]) == composition
            # comp_mask_train = sim_train.le.inverse_transform(train_targets) == composition
            comp_score_train = accuracy_score(y_train[comp_mask_train], train_pred[comp_mask_train])
            ...
            comp_score_test = accuracy_score(y_test[comp_mask_test], test_pred[comp_mask_test])
