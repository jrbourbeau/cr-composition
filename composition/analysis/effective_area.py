...
# from useful.useful import getMids

@export
def get_effective_area(df_sim):
    ...
    log_energy_bins = np.arange(6.2, 8.1, log_energy_bin_width)
    # Convert energy bins to be linear in energy
    energy_bins = 10.0**log_energy_bins
