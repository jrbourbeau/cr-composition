...
class IceTop_LLH_Ratio(icetray.I3ConditionalModule):
    def __init__(self,ctx):
        ...
        self.AddParameter('GeometryHDF5','I3Geometry booked in HDF file',
                          '/data/user/jbourbeau/composition/geometry.hdf5')
                        #   '/data/user/zgriffith/llhratio_files/geometry.h5')
    ...
    def Configure(self):
        ...
        self.highEbins = self.GetParameter('highEbins')
