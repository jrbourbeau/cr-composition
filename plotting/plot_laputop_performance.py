...
if __name__ == '__main__':
    ...
    for config in args.config:
        ...
        medians_heavy, stds_heavy, _ = comp.analysis.get_median_std(
        ...
        plotting.plot_steps(energybins.log_energy_bins, medians_light, lw=1,
                            color=color_dict['light'], label='light', ax=ax1)
        plotting.plot_steps(energybins.log_energy_bins, medians_heavy, lw=1,
        ...
        plotting.plot_steps(energybins.log_energy_bins, stds_heavy, lw=1,
        ...
        for composition in comp_list:
            ...
            core_res = comp.analysis.get_resolution(energy, core_diff, energybins.energy_bins)
            plotting.plot_steps(energybins.log_energy_bins, core_res, lw=1,
        ...
        for composition in comp_list:
            ...
            angular_res = comp.analysis.get_resolution(energy, ang_diff_deg, energybins.energy_bins)
            plotting.plot_steps(energybins.log_energy_bins, angular_res, lw=1,
                                color=color_dict[composition], label=composition, ax=ax)
        ax.set_ylim([0.0, 0.4])
        ax.set_xlim(energybins.log_energy_min, energybins.log_energy_max)
